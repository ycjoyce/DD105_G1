...
try {
    ...
    $mail->Body    = '<h1 style="font-size: 1em;font-family:Microsoft JhengHei;"> 親愛的 ' . $memName . ' 您好:</h1><br><p style="font-family:Microsoft JhengHei; color: rgb(255, 77, 77);">這是您的密碼 : '.$memPsw.'</p><br><p style="font-family:Microsoft JhengHei;">請盡快登入以重新驗證。</p><br><br><p style="font-family:Microsoft JhengHei;">浪愛回家團隊 敬上</p>
