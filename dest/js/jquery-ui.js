"use strict";var _typeof2=require("babel-runtime/helpers/typeof");var _typeof3=_interopRequireDefault(_typeof2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/*! jQuery UI - v1.12.1 - 2020-02-22
* http://jqueryui.com
...
}if(inst.inline){this._updateDatepicker(inst);}else{this._hideDatepicker();this._lastInput=inst.input[0];if((0,_typeof3.default)(inst.input[0])!=="object"){inst.input.trigger("focus");// restore focus
...
if((typeof option==="undefined"?"undefined":(0,_typeof3.default)(option))==="object"&&!option.effect){return true;}// Didn't match any standard API
...
//>>demos: http://jqueryui.com/effect/
var effect;if($.uiBackCompat!==false){effect=$.effects.define("transfer",function(options,done){$(this).transfer(options,done);});}var effectsEffectTransfer=effect;});n() {
		this.element.attr( {
